...
$this->registerMetaTag(['name' =>
'keywords', 'content' => $this->params['meta_keywords'] ?? '']);
$this->registerLinkTag(['rel' => 'icon', 'type' => 'image/x-icon', 'href' =>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Heading -->
            <div class="sidebar-heading">Election</div>
            ...
            <!-- Nav Item - Voters Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= Yii::$app->urlManager->createUrl(['/vote/result']) ?>"">
                    <i class=" fas fa-fw fa-wrench"></i>
                    <span>Result</span>
                </a>
            </li>
            ...
            <!-- Heading -->
            <div class="sidebar-heading"><i class="fas fa-fw fa-cog"></i>Settings</div>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">A new user registered!</span>
                                    </div>
                                </a>
                        ...
                        <?php if (Yii::$app->user->isGuest) : ?>
                            <li class="nav-item dropdown no-arrow mx-1">
                                <?= Html::a('Login', ['/site/login'], ['class' => 'nav-link text-primary']) ?>
                            </li>
                        <?php else : ?>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Jackierielsoft 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
